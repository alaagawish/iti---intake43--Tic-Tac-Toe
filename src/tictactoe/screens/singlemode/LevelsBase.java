...
public class LevelsBase extends BorderPane {
    ...
    public LevelsBase(Stage stage) {
        ...
        easyButton.setOnAction(e -> {
            Parent pane = new GameBase(stage, Level.Easy, playerOne, computer,null);
            stage.getScene().setRoot(pane);
        });

        mediumButton.setOnAction(e -> {
            Parent pane = new GameBase(stage, Level.MEDIUM, playerOne, computer,null);
            stage.getScene().setRoot(pane);
        });

        hardButton.setOnAction(e -> {
            Parent pane = new GameBase(stage, Level.HARD, playerOne, computer,null);
            stage.getScene().setRoot(pane);
        });
